...
(function(){
  ...
  function reviseCases(rawCases){
    ...
    if(c38){
      ...
      c38.corrected="麟閣〔圖〕形，乌（台腾实。悲缠奄息，伤怀尹姞。永叨恩隆，垂裕韐韠。维地河山，〔配〕天箕毕。懿范昭兹，德音洋溢。）。";
      c38.basis="文献对校＋AI语境暂拟";
      c38.mode="mixed";
      c38.confidence="分项判断";
      c38.source="《唐文拾遗》等录文明确保存“麟阁图形，乌台腾实”，因此“麟閣□形”中的缺字可据文献补作“圖”；“□天箕毕”仍未见可以完全确定原字的现存拓片字形。";
      c38.analysis=["《唐文拾遗》等录文明确作“麟阁图形，乌台腾实”，所以“麟閣□形”中的缺字可以确定为“圖”。","“配天”是碑铭中常见表达，与“维地河山”形成天地对应，因此对第二处缺字仍暂拟〔配〕。","后续续录没有现存网页字框，不能为“□天箕毕”设置虚构红框。"];
      c38.usage="本例中的〔圖〕属于文献对校结果；〔配〕仍为AI语境候选。栏目二继续保留两个原始“□”。";
