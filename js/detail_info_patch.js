...
(function(){
  ...
  const dataUrl="data/beitie_header_info.json?v=20260723_zunhao_shanrang_v1";

  function forceDedicatedRouter(){
    if(!["007","010","011","013","014","015","016"].includes(workId)||document.querySelector("script[data-dedicated-forced-router]"))return;
