...
(function(){
  "use strict";
  if(window.__DETAIL_INFO_STABLE_ENTRY_V42__)return;
  ...
  const dataUrl="data/beitie_header_info.json?v=20260726_mengjingxun_043_v2_page_crowdsource";
  ...
  const recoveryVersion="20260726_mengjingxun_043_v2_page_crowdsource";
  ...
  const routedWorks=new Set(["001","002","003","004","005","006","007","010","011","013","014","015","016","017","018","020","022","023","024","025","026","027","028","029","030","032","033","034","035","036","043"]);

  function applyImmediateWorkMenu(){
    const names={"024":"张从申书李玄靖碑","025":"集王羲之书三藏圣教序","026":"麻姑山仙坛记","027":"旧拓魏志五种","028":"晋唐小楷九种","029":"鲜于光祖墓志","030":"九成宫醴泉铭","032":"许真人井铭","033":"争座位帖","034":"章吉老墓志","035":"武氏祠画像题字","036":"瘗鹤铭","043":"司马昞妻孟敬训墓志"};
