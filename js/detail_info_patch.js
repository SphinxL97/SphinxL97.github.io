...
(function(){
  "use strict";
  if(window.__DETAIL_INFO_STABLE_ENTRY_V16__)return;
  ...
  const coreUrl="js/detail_info_patch_core.js?v=20260724_equal_height_header_v1";
  const dataUrl="data/beitie_header_info.json?v=20260724_wangjushi_v1";

  function forceDedicatedRouter(){
    if(!["007","010","011","013","014","015","016","017","018","020","022"].includes(workId)||document.querySelector("script[data-dedicated-forced-router]"))return;
    ...
    script.src="js/damage_ai_reading.js?v=20260724_wangjushi_v1";
    script.async=false;
