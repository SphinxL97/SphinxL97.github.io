...
(function(){
  "use strict";
  if(window.__DAMAGE_AI_READING_ROUTER_V45__)return;
  window.__DAMAGE_AI_READING_ROUTER_V45__=true;
  ...
  const routes={
    ...
    "007":[
      {src:"js/work-007-coordinate-adapter.js?v=20260722_yique_all_cases_v5",key:"w007c",ready:()=>Boolean(window.__WORK_007_COORDINATE_ADAPTER__)},
