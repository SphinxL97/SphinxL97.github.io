...
(function(){
  ...
  function installMask(){
    if(["007","010","011","013","014","015","016","017","018","020","022","023","024","025","026","027","028","029","030","032","033","034"].includes(id)||document.getElementById("detail-route-pending-style"))return;
