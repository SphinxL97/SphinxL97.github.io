...
(function(){
  "use strict";
  if(window.__DAMAGE_AI_READING_ROUTER_V82__)return;
  ...
  window.__DAMAGE_AI_READING_ROUTER_V79__=true;
  ...
  const routes={
    ...
    "035":[{src:"js/work-035-coordinate-adapter.js?v=20260726_wushici_035_v4",key:"w035c",ready:()=>Boolean(window.__WORK_035_COORDINATE_ADAPTER__)},{src:"js/work-035.js?v=20260726_wushici_035_v4",key:"w035",ready:()=>Boolean(window.__WORK_035_STABLE_READY__&&window.__WORK_035_CROWDSOURCE_READY__)}],
    "036":[{src:"js/work-036-coordinate-adapter.js?v=20260726_yiheming_036_v2_caption",key:"w036c",ready:()=>Boolean(window.__WORK_036_COORDINATE_ADAPTER__)},{src:"js/work-036.js?v=20260726_yiheming_036_v2_caption",key:"w036",ready:()=>Boolean(window.__WORK_036_STABLE_READY__&&window.__WORK_036_CROWDSOURCE_READY__)}],
    "043":[{src:"js/work-043.js?v=20260726_mengjingxun_043_v2_page_crowdsource",key:"w043",ready:()=>Boolean(window.__WORK_043_STABLE_READY__&&window.__WORK_043_CROWDSOURCE_READY__)}]
  };
  ...
  function installMask(){
    if(["007","010","011","013","014","015","016","017","018","020","022","023","024","025","026","027","028","029","030","032","033","034","035","036","043"].includes(id)||document.getElementById("detail-route-pending-style"))return;
  ...
  async function start(){
    ...
    if(!["003","004","005","006","007","010","011","013","014","015","016","017","018","020","022","023","024","025","026","027","028","029","030","033","043"].includes(id)){
