...
(function(){
  "use strict";
  if(window.__DAMAGE_AI_READING_ROUTER_V16__)return;
  window.__DAMAGE_AI_READING_ROUTER_V16__=true;
  ...
  const routes={
    ...
    "005":[
      ...
      {src:"js/work-005-yugonggong-all-v2.js?v=20260720_recovery_v1",key:"work005AllDamageReview",ready:()=>Boolean(window.__WORK_005_CONTENT_READY__)},
