...
(function(){
  ...
  const routes={
    ...
    "035":[{src:"js/work-035-coordinate-adapter.js?v=20260726_wushici_035_v2",key:"w035c",ready:()=>Boolean(window.__WORK_035_COORDINATE_ADAPTER__)},{src:"js/work-035.js?v=20260726_wushici_035_v2",key:"w035",ready:()=>Boolean(window.__WORK_035_STABLE_READY__&&window.__WORK_035_CROWDSOURCE_READY__)}]
  };
