...
(function(){
  "use strict";
  if(window.__DAMAGE_AI_READING_ROUTER_V81__)return;
  ...
  const routes={
    ...
    "043":[{src:"js/work-043.js?v=20260726_mengjingxun_043_v1",key:"w043",ready:()=>Boolean(window.__WORK_043_STABLE_READY__&&window.__WORK_043_CROWDSOURCE_READY__)}]
  };
