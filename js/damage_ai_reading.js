...
(function(){
  ...
  const routes={
    ...
    "027":[
      {src:"js/work-027-coordinate-adapter.js?v=20260724_wei_five_v2",key:"w027c",ready:()=>Boolean(window.__WORK_027_COORDINATE_ADAPTER__)},
      {src:"js/work-027.js?v=20260724_wei_five_v2",key:"w027",ready:()=>Boolean(window.__WORK_027_STABLE_READY__&&window.__WORK_027_CROWDSOURCE_READY__)}
    ]
  };
