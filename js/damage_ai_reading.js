...
(function(){
  "use strict";
  if(window.__DAMAGE_AI_READING_ROUTER_V17__)return;
  window.__DAMAGE_AI_READING_ROUTER_V17__=true;
  ...
  const routes={
    ...
    "005":[
      ...
      {src:"js/work-005-performance-patch.js?v=20260720_recovery_v1",key:"work005PerformancePatch",ready:()=>Boolean(window.__WORK_005_PERFORMANCE_PATCH_V1__)},
      {src:"js/work-005-yugonggong-all-v2.js?v=20260720_recovery_v2",key:"work005AllDamageReview",ready:()=>Boolean(window.__WORK_005_CONTENT_READY__)},
      {src:"js/work-005-column4-highlight.js?v=20260720_final_v2",key:"work005Column4Highlight",ready:()=>Boolean(window.__WORK_005_COLUMN4_HIGHLIGHT_V1__)}
    ]
  };
