...
(function(){
  "use strict";
  if(window.__DAMAGE_AI_READING_ROUTER_V47__)return;
  ...
  const routes={
    ...
    "007":[
      {src:"js/work-007-coordinate-adapter.js?v=20260722_yique_demand_v7",key:"w007c",ready:()=>Boolean(window.__WORK_007_COORDINATE_ADAPTER__)},
      {src:"js/work-007.js?v=20260722_yique_demand_v7",key:"w007",ready:()=>Boolean(window.__WORK_007_STABLE_READY__)}
    ]
  };
