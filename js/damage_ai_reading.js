...
(function(){
  "use strict";
  if(window.__DAMAGE_AI_READING_ROUTER_V11__)return;
  window.__DAMAGE_AI_READING_ROUTER_V11__=true;
  ...
  const routes={
    ...
    "005":[
      {src:"js/work-005-yugonggong-all-v2.js?v=20260720_review_v2",key:"work005AllDamageReview",ready:()=>Boolean(window.__WORK_005_CONTENT_READY__)}
    ]
  };
