...
(function(){
  ...
  const CASES=[
    ...
    },
    {
      ...
      e:[
        "栏目二原释文在“禁”字之后明确保留一个“□”，本例只处理这一处缺字，不改变句中其他文字。",
        "本句连续列举钟磬、瑟鼓、雷洗、觞觚、爵、鹿、柤、梪、笾、柉等礼乐器物，因此缺字也应处于器物名称的并列结构中。",
        "相关录文常将此处连读为“笾柉禁壶”，“壶”在字数上与一个“□”相合，也符合礼器列举的语境。",
        "第13页拓片中该字位位于“禁”之后，栏目三保留真实拓片局部和红框，供读者继续核验字形。",
        "因此本处暂恢复为“壶”；如果更清晰旧拓显示不同字形，应据拓片重新修订。"
      ]
    },
    {
